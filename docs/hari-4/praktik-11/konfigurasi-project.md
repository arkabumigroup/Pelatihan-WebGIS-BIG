...
Isi file yang perlu diperiksa ditampilkan di halaman ini supaya Anda dapat memahami maksudnya. Dua skrip pemeriksa pada folder `scripts` tidak ditampilkan karena berkasnya panjang, dan keduanya cukup dipastikan ada lalu dijalankan pada Tahap 8.
