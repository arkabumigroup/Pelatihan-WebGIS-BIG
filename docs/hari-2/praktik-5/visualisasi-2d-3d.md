...
![Explorer VS Code menampilkan folder components peta3d-latihan-5 dengan addDataVektor2D.jsx yang baru dibuat](visualisasi-2d-3d/image1.png)
...
![Signature fungsi addDataVektor2D dengan parameter viewer, opsi, dan selesai](visualisasi-2d-3d/image2.png)
...
![Baris const Cesium = window.Cesium di dalam addDataVektor2D](visualisasi-2d-3d/image3.png)
...
![Blok const yang membaca opsi addDataVektor2D berisi url, nama, warna, warnaOutline, lebarGaris, nempelTerrain, dan otomatisZoom](visualisasi-2d-3d/image.png)
...
![Blok if yang memeriksa url, memanggil selesai dengan null, lalu menghentikan proses dengan return](visualisasi-2d-3d/image%201.png)
...
![Pemanggilan Cesium.GeoJsonDataSource.load dengan opsi clampToGround](visualisasi-2d-3d/image6.png)
...
![Callback .then dengan parameter dataSource masih kosong setelah Cesium.GeoJsonDataSource.load](visualisasi-2d-3d/image%202.png)
...
![Callback .then mengeset dataSource.name dan menambahkannya ke viewer.dataSources](visualisasi-2d-3d/image8.png)
...
![Perulangan dataSource.entities.values.forEach(function (entity)) masih kosong](visualisasi-2d-3d/image9.png)
...
![Blok if (entity.polyline) mengatur material PolylineOutline, ketebalan garis, dan clampToGround](visualisasi-2d-3d/image10.png)
...
![Blok if (entity.polygon) mengatur classificationType menjadi Cesium.ClassificationType.TERRAIN](visualisasi-2d-3d/image11.png)
...
![Blok if (otomatisZoom) memanggil viewer.flyTo dan selesai(dataSource) menutup callback](visualisasi-2d-3d/image12.png)
...
![Folder public/data berisi batas_admin.geojson, jalan.geojson, latihan.kml, dan pola_ruang.tif](visualisasi-2d-3d/image13.png)
...
![Baris const Cesium = window.Cesium di awal function addContent3D pada CesiumViewer.jsx](visualisasi-2d-3d/image14.png)
...
![Pemanggilan addDataVektor2D untuk jalan.geojson dengan nama Jaringan Jalan, warna kuning, lebarGaris 4, dan otomatisZoom false](visualisasi-2d-3d/image%203.png)
    
4. Selanjutnya tambahkan data berupa batas administrasi dengan cara yang sama.
    
![Callback jaringanJalan memanggil addDataVektor2D untuk batas_admin.geojson dengan nama Batas Administrasi dan warna area cyan transparan](visualisasi-2d-3d/image%204.png)
...
![Pemanggilan addPanelLayer3D yang mendaftarkan Jaringan Jalan dan Batas Administrasi sebagai layer bersama kontrolTerrain](visualisasi-2d-3d/image%205.png)
    
6. Tahap terakhir pastikan addDataVektor2D sudah terimport dalam **CesiumViewer.jsx**.
    
![Baris import addDataVektor2D dari ./addDataVektor2D di CesiumViewer.jsx](visualisasi-2d-3d/image18.png)
...
![Peta 3D dengan area batas administrasi berwarna hijau dan garis jalan kuning di atas citra satelit serta bangunan 3D](visualisasi-2d-3d/image%206.png)

### addDataVektor2D.jsx, kode lengkap
