...
Langkah berikutnya ada pada halaman [Google Cloud Platform](/hari-3/deployment-project/google-cloud-platform), Tahap 2. Di sana Nama Peserta dan Project ID dipakai untuk menetapkan identitas Anda, yang kemudian menurunkan nama VM, nama Service Account, dan subdomain Anda.
